...
#ifndef PROTOCOL_BASED_VIPER_SWIFT_H
#define PROTOCOL_BASED_VIPER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="protocol_based_viper",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20protocol_based_viper11AppDelegate")
...
SWIFT_CLASS("_TtC20protocol_based_viper13SceneDelegate")
...
SWIFT_CLASS("_TtC20protocol_based_viper18UserViewController")
...
@interface UserViewController (SWIFT_EXTENSION(protocol_based_viper)) <UITableViewDataSource, UITableViewDelegate>
